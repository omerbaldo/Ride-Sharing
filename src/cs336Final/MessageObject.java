...
public class MessageObject {
	...
	public static Boolean sendmsg(LoginObject user, String To, String Subject, String Content, String Date){
		try
		{
			...
			System.out.println("Trying to insert" + To + Subject + Content + Date);
