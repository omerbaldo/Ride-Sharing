...
public class registrationClass 
{
	public static boolean register (String username, String password, String email, String phone, String address)
	{
		try
		{
			...
			String str = "INSERT INTO app.User (typeofuser,username,password,email,address,phone_number,age,active) VALUES (3,\""+username+"\",\""+password+"\",\""+email+"\",\""+address+"\",\""+phone+"\",30,1)";
	...
	public static boolean registerSupport (String username, String password, String email, String phone, String address)
	{
		try
		{
			...
			//Populate SQL statement with an actual query. It returns a single number. The number of beers in the DB.
			String str = "INSERT INTO app.User (typeofuser,username,password,email,address,phone_number,age,active) VALUES (2,\""+username+"\",\""+password+"\",\""+email+"\",\""+address+"\",\""+phone+"\",30,1)";
			System.out.print(str);
			//Run the query against the DB
			int result = stmt.executeUpdate(str);
